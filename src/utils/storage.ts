...
export function loadSettings(): SiteSettings {
  try {
    ...
    return {
      ...
      heroCoverPositionMobile: parsed.heroCoverPositionMobile || DEFAULT_SETTINGS.heroCoverPositionMobile || '50% 50%',
      heroCoverPositionDesktop: parsed.heroCoverPositionDesktop || DEFAULT_SETTINGS.heroCoverPositionDesktop || '50% 50%',
      toursCoverImage: parsed.toursCoverImage !== undefined ? parsed.toursCoverImage : (DEFAULT_SETTINGS.toursCoverImage || ''),
      ...
      servicesCoverPositionMobile: parsed.servicesCoverPositionMobile || DEFAULT_SETTINGS.servicesCoverPositionMobile || '50% 50%',
      servicesCoverPositionDesktop: parsed.servicesCoverPositionDesktop || DEFAULT_SETTINGS.servicesCoverPositionDesktop || '50% 50%',
