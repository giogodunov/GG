...
export function loadSettings(): SiteSettings {
  try {
    ...
    return {
      ...
      heroCoverImage: parsed.heroCoverImage || DEFAULT_SETTINGS.heroCoverImage || '',
      heroCoverOverlayOpacity: parsed.heroCoverOverlayOpacity !== undefined ? parsed.heroCoverOverlayOpacity : (DEFAULT_SETTINGS.heroCoverOverlayOpacity ?? 30),
      heroTextColorMode: parsed.heroTextColorMode || DEFAULT_SETTINGS.heroTextColorMode || 'light',
      heroCoverPositionMobile: parsed.heroCoverPositionMobile || DEFAULT_SETTINGS.heroCoverPositionMobile || '32% 30%',
      heroCoverPositionDesktop: parsed.heroCoverPositionDesktop || DEFAULT_SETTINGS.heroCoverPositionDesktop || '34% 51%',
      toursCoverImage: parsed.toursCoverImage || DEFAULT_SETTINGS.toursCoverImage || '',
      toursCoverOverlayOpacity: parsed.toursCoverOverlayOpacity !== undefined ? parsed.toursCoverOverlayOpacity : 35,
      toursTextColorMode: parsed.toursTextColorMode || DEFAULT_SETTINGS.toursTextColorMode || 'auto',
      toursCoverPositionMobile: parsed.toursCoverPositionMobile || DEFAULT_SETTINGS.toursCoverPositionMobile || '50% 50%',
      toursCoverPositionDesktop: parsed.toursCoverPositionDesktop || DEFAULT_SETTINGS.toursCoverPositionDesktop || '50% 50%',
      servicesCoverImage: parsed.servicesCoverImage || DEFAULT_SETTINGS.servicesCoverImage || '',
      servicesCoverOverlayOpacity: parsed.servicesCoverOverlayOpacity !== undefined ? parsed.servicesCoverOverlayOpacity : (DEFAULT_SETTINGS.servicesCoverOverlayOpacity ?? 35),
      servicesTextColorMode: parsed.servicesTextColorMode || DEFAULT_SETTINGS.servicesTextColorMode || 'light',
      servicesCoverPositionMobile: parsed.servicesCoverPositionMobile || DEFAULT_SETTINGS.servicesCoverPositionMobile || '52% 31%',
      servicesCoverPositionDesktop: parsed.servicesCoverPositionDesktop || DEFAULT_SETTINGS.servicesCoverPositionDesktop || '50% 15%',
      guidesCoverImage: parsed.guidesCoverImage !== undefined ? parsed.guidesCoverImage : (DEFAULT_SETTINGS.guidesCoverImage || ''),
      guidesCoverOverlayOpacity: parsed.guidesCoverOverlayOpacity !== undefined ? parsed.guidesCoverOverlayOpacity : 35,
      guidesTextColorMode: parsed.guidesTextColorMode || DEFAULT_SETTINGS.guidesTextColorMode || 'auto',
      guidesCoverPositionMobile: parsed.guidesCoverPositionMobile || DEFAULT_SETTINGS.guidesCoverPositionMobile || '50% 50%',
      guidesCoverPositionDesktop: parsed.guidesCoverPositionDesktop || DEFAULT_SETTINGS.guidesCoverPositionDesktop || '50% 50%',
      faqCoverImage: parsed.faqCoverImage !== undefined ? parsed.faqCoverImage : (DEFAULT_SETTINGS.faqCoverImage || ''),
      faqCoverOverlayOpacity: parsed.faqCoverOverlayOpacity !== undefined ? parsed.faqCoverOverlayOpacity : 35,
      faqTextColorMode: parsed.faqTextColorMode || DEFAULT_SETTINGS.faqTextColorMode || 'auto',
      faqCoverPositionMobile: parsed.faqCoverPositionMobile || DEFAULT_SETTINGS.faqCoverPositionMobile || '50% 50%',
      faqCoverPositionDesktop: parsed.faqCoverPositionDesktop || DEFAULT_SETTINGS.faqCoverPositionDesktop || '50% 50%',
      footerCoverImage: parsed.footerCoverImage !== undefined ? parsed.footerCoverImage : (DEFAULT_SETTINGS.footerCoverImage || ''),
      footerCoverOverlayOpacity: parsed.footerCoverOverlayOpacity !== undefined ? parsed.footerCoverOverlayOpacity : 35,
      footerTextColorMode: parsed.footerTextColorMode || DEFAULT_SETTINGS.footerTextColorMode || 'auto',
      footerCoverPositionMobile: parsed.footerCoverPositionMobile || DEFAULT_SETTINGS.footerCoverPositionMobile || '50% 50%',
