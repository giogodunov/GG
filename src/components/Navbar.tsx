  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex flex-1 justify-center items-center gap-3 lg:gap-6 xl:gap-10 text-[11px] lg:text-xs uppercase tracking-wider lg:tracking-widest text-emerald-100/80 font-medium px-2 lg:px-4">
          {navItems.map((item) => (
            <button
              key={item.id}
              id={`nav-link-${item.id}`}
        ...
        <div className="hidden md:flex items-center gap-2 lg:gap-3">
          ...
          <a
            ...
            className="flex items-center gap-1.5 lg:gap-2 bg-[#25D366] text-white px-3 lg:px-3.5 py-2 rounded-xl text-xs font-bold tracking-wide hover:brightness-105 transition-all shadow-sm"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 bg-amber-400 hover:bg-amber-300 text-[#1B3B2B] px-3.5 lg:px-4 py-2 rounded-xl text-xs font-bold uppercase tracking-wider transition-all shadow-sm cursor-pointer whitespace-nowrap"
          >
            <span>{t.navBook}</span>
          </button>
          ...
          {isAdminAuthorized && (
            ...
            >
              ...
              <span className="hidden xl:inline">{t.adminPanelBtn}</span>
              {newInquiriesCount > 0 && (
    ...
    {mobileMenuOpen && (
      <div
        id="mobile-nav-menu"
        className="md:hidden border-t border-emerald-900/50 bg-[#1B3B2B] px-4 pt-3 pb-6 space-y-3 shadow-lg"
      >
