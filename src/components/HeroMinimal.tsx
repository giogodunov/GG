    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-end w-full">
        <div className="max-w-xl sm:max-w-2xl lg:max-w-3xl w-full flex flex-col items-end text-right">
          ...
          {/* Subtext */}
          <p
            className={`text-sm sm:text-lg max-w-xl font-normal leading-relaxed text-right ml-auto ${
          ...
          <div className="mt-7 sm:mt-8 flex flex-wrap items-center gap-2.5 sm:gap-3 justify-end w-full">
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#25D366] text-white px-5 sm:px-6 py-3 sm:py-3.5 rounded-xl font-bold text-xs tracking-wider uppercase hover:opacity-90 transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5"
            >
